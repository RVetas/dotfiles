...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    hi Todo guifg=#aeb7c0 guibg=NONE gui=NONE cterm=NONE
    ...
    if g:xcodehc_green_comments
      ...
      hi Todo guifg=#b8f08d guibg=NONE gui=NONE cterm=NONE
    endif
  ...
  hi Statement guifg=#9c2191 guibg=NONE gui=NONE cterm=NONE
  ...
  hi Todo guifg=#5c6873 guibg=NONE gui=NONE cterm=NONE
  ...
  if g:xcodehc_green_comments
    ...
    hi Todo guifg=#1f6300 guibg=NONE gui=NONE cterm=NONE
  endif
  if g:xcodehc_emph_types
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi Todo ctermfg=249 ctermbg=NONE cterm=NONE
    ...
    if g:xcodehc_green_comments
      ...
      hi Todo ctermfg=156 ctermbg=NONE cterm=NONE
    endif
    if g:xcodehc_emph_types
  ...
  hi Todo ctermfg=241 ctermbg=NONE cterm=NONE
  ...
  if g:xcodehc_green_comments
    ...
    hi Todo ctermfg=22 ctermbg=NONE cterm=NONE
  endif
  if g:xcodehc_emph_types
